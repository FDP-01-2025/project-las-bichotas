...
// se crearon las preguntas para puego ser llamada como un vector dentro de nuestro codigo principal, el estruc cuenta con el vector string el cual esta separado del string texto para poder ser separados en las preguntas
// la variable char es usada para dar nuestra respuesta, la cual se compara en nuestro code de trivia, el pregrama busca si el char ingresado es similar al que esta dentro del strcut para determinar si es correcto
